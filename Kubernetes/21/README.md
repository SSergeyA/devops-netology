...
```    
## Выполнение   
Запустил [скрипт](https://github.com/SSergeyA/devops-netology/blob/main/Kubernetes/21/yc_env.sh) чтобы добавить в переменные окружения credentials    
Потом запустил манифест [терраформ](https://github.com/SSergeyA/devops-netology/blob/main/Kubernetes/21/main.tf) и проверил. что открывается картинка при одном выключенном сервере (я попробовал и поставил доустимым 2 вылючнных, тоже работает)    
